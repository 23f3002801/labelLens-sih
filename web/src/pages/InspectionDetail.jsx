          ...
          {inspection && (
            <div className="flex items-center gap-3">
              ...
              <span className={`inline-flex items-center gap-2 px-4 py-2 rounded-full text-sm font-semibold ${
                isCompliant ? 'bg-success-container text-on-success-container' : 'bg-error-container text-on-error-container'
              }`}>
                <span className="material-symbols-outlined text-[18px]">{isCompliant ? 'check_circle' : 'error'}</span>
                {isCompliant ? '100% Compliant' : 'Violations Found'}
              </span>
            </div>
          )}
        </div>
