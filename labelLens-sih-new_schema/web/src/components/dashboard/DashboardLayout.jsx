...
const NAV_ITEMS = [
  ...
  { name: 'New Scan', path: '/dashboard/scan', icon: 'add_a_photo', roles: null },
  { name: 'Inspections', path: '/dashboard/inspections', icon: 'fact_check', roles: null },
  { name: 'Complaints', path: '/dashboard/complaints', icon: 'gavel', roles: ['CONSUMER', 'REVIEWER', 'CONTROLLER', 'DIRECTOR'] },
  { name: 'Reports', path: '/dashboard/reports', icon: 'description', roles: ['REVIEWER', 'CONTROLLER', 'DIRECTOR'] },
];
